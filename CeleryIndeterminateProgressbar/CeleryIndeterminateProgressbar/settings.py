"""
Django settings for CeleryIndeterminateProgressbar project.
...
SECRET_KEY = 'django-insecure-#e=4$p#6q=*dbhe5*$tzv51hc=^-6@i+01r_uv%*#g!6627!it'
...
ROOT_URLCONF = 'CeleryIndeterminateProgressbar.urls'
