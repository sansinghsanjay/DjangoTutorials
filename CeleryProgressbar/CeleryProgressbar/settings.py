"""
Django settings for CeleryProgressbar project.
...
SECRET_KEY = 'django-insecure-apy#vua#)a!jpnx-^(=w^6c+8++p2c)r-jf^jrv*mu=oif#f%_'
...
ROOT_URLCONF = 'CeleryProgressbar.urls'
